...
import com.slackcat.modules.simple.ThreadTestModule
...
object SlackcatModules {
     ...
     */
    val all: List<KClass<out SlackcatModule>> =
        listOf(
            // Simple modules
            PingModule::class,
            DateModule::class,
     ...
     */
    val simple: List<KClass<out SlackcatModule>> =
        listOf(
            PingModule::class,
            DateModule::class,
            FlipModule::class,
     ...
     */
    val `fun`: List<KClass<out SlackcatModule>> =
        listOf(
            PokeCatModule::class,
            EmojiModule::class,
            FlipModule::class,
     ...
     */
    val utility: List<KClass<out SlackcatModule>> =
        listOf(
            PingModule::class,
            DateModule::class,
            ChannelModule::class,
     ...
     */
    val gamification: List<KClass<out SlackcatModule>> =
        listOf(
            KudosModule::class,
            LearnModule::class,
        )
     ...
     */
    val requiresApiKeys: List<KClass<out SlackcatModule>> =
        listOf(
            WeatherModule::class,
            TranslateModule::class,
            CryptoPriceModule::class,
